...
Pacchetto per trasportare gli oid/vendor/servizi da JSON a PocketBase

## Using

To add and install this package as a dependency of your project, run `poetry add oid-pocketbase`.
